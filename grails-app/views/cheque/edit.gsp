...
<html>
    ...
    <body>
        ...
        <div id="edit-cheque" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.cheque}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.cheque}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.cheque}" method="PUT">
                <g:hiddenField name="version" value="${this.cheque?.version}" />
                <fieldset class="form">
                    <f:all bean="cheque"/>
                </fieldset>
