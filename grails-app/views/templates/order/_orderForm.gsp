    ...
    <div class="profile-sidebar">
        ...
        <div class="col-md-12">
            <ul class="list-unstyled profile-nav">
                ...
                <li>
                    <label for="orderId"><g:message code="order.orderId"/></label>
                    <span> <input type="text" id="orderId" disabled/></span>
                </li>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"><g:message code="express.account.list.name" default="Account Name"/></label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"><g:message code="order.orderDate"/></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <g:select class="form-control" from="${params?.orderStatus}"
                                          valueMessagePrefix="Order" name="orderStatus"/>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label"><g:message code="order.momentBalance"/></label>
...
<script>
    ...
    $(document).ready(function () {
        orderForm.fillOrderInfo("${params?.record}".replace(/&quot;/g, '"'));
    });
