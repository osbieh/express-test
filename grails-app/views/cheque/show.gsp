...
<html>
    ...
    <body>
        ...
        <div id="show-cheque" class="content scaffold-show" role="main">
            ...
            <f:display bean="cheque" />
            <g:form resource="${this.cheque}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.cheque}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
